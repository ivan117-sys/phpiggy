...
use Framework\App;
use App\Controllers\{HomeController, AboutController, RegisterController, TransactionController, ReceiptController, ErrorController};
...
function registerRoutes(App $app)
{
  ...
  $app->post('/register', [RegisterController::class, 'registerData'])->add(GuestOnlyMiddleware::class);
  $app->post('/login', [RegisterController::class, 'loginData'])->add(GuestOnlyMiddleware::class);
  $app->get('/login', [RegisterController::class, 'login'])->add(GuestOnlyMiddleware::class);
